...
- Publishing details of a real building's security-relevant infrastructure
  belonging to someone who has not consented to it being made public
...
reported to the maintainers through GitHub's private reporting, or at the
contact address in `package.json`. All complaints will be reviewed and
...
**2. Warning** — a warning with consequences for continued behaviour, and no
